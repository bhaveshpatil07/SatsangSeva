...
const Footer = ({
  ...
  return (
    <footer
      className={`self-stretch bg-darkorange-100 flex flex-col items-center justify-start pt-11 px-5 pb-[17px] box-border relative gap-[69px] max-w-full text-left text-lg text-white font-dm-sans mq750:gap-[34px] mq450:gap-[17px] mq450:pt-[29px] mq450:pb-5 mq450:box-border ${className}`}
      style={footerStyle}
    >
      ...
      <div className="w-[1240px] flex flex-row items-start justify-between max-w-full gap-[20px] lg:flex-wrap lg:justify-center">
        ...
        <div className="w-[364px] flex flex-col items-start justify-start pt-4 px-0 pb-0 box-border max-w-full">
          <div className="self-stretch flex flex-col items-start justify-start gap-[21.5px] max-w-full">
            ...
            <div className="self-stretch rounded-[45.59px] bg-white box-border flex flex-row items-start justify-start pt-[5px] pb-1 pr-1 pl-[25px] gap-[36.2px] max-w-full z-[1] text-smi-2 text-darkgray-300 border-[2px] border-solid border-whitesmoke-300 mq450:flex-wrap mq450:gap-[18px]">
              ...
              <Button
                className="h-[46.4px] flex-1 shadow-[0px_10px_50px_rgba(61,_55,_241,_0.25)] min-w-[97px] z-[1]"
                variant="contained"
                sx={{
                  textTransform: "none",
                  color: "#fff",
